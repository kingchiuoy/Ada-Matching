...
public class State {
    ...
    public double prev_prob;
    public boolean prev_delete = false;
    public List<Double> PrevTransitionScore = new ArrayList<>();
    public List<Double> PrevTransitionVelocity = new ArrayList<>();
    public double prev_speed_score;
    public State max_prev;
    public double prev_min_path;

    public double rev_prob;
    public boolean rev_delete = false;
    public List<Double> RevTransitionScore = new ArrayList<>();
    public List<Double> RevTransitionVelocity = new ArrayList<>();
    public double rev_speed_score;
    public State max_next;
    public double rev_min_path;
