...
public class SequenceState<S, O, D> {
    ...
    public SequenceState(S state, O observation, D path) {
        this.state = state;
    ...
    public String toString() {
        return "SequenceState [state=" + state + ", observation=" + observation + ", path=" + path + "]";
    }

    @Override
    public int hashCode() {
        return Objects.hash(state, observation, path);
    }
